...
const ProductDescription = () => {
  return (
    ...
    <div className="flex justify-center mt-2 md:mt-4">
        <div className="artboard artboard-horizontal lg:h-auto sm:min-h-40 bg-white p-4 md:p-8 rounded-lg shadow-lg flex flex-col md:flex-row"> 
        
            
            {/* Placeholder for Image */}
            <div className="flex-none w-full md:w-1/2 mt-4 md:mt-14 md:mb-0 md:mr-8 lg:-mt-0">
            <div className="w-full h-48 lg:h-80 max-h-1/2 md:max-h-full rounded overflow-hidden">
            ...
            <div className="flex flex-col justify-center space-y-3 md:space-y-4 w-full md:w-1/2">
                <div className="flex items-center space-x-1 md:space-x-2 mb-2 md:mb-4 mt-2 ml-10 mb:ml-20 lg:ml-60">
                    <FaInfoCircle className="text-primary w-5 mt-2 h-5 md:w-6 md:h-6" />
